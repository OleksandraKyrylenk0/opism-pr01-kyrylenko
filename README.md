...
|---|---|---|---|
| 1 | Результат | <code><HTML><HEAD><meta http-equiv="content-type" content="text/html;charset=utf-8"><TITLE>301 Moved</TITLE></HEAD><BODY></BODY></HTML><!DOCTYPE html></code> | Готовий код і текст сторінки, який бачить користувач |
